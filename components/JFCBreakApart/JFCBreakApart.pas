...
type
  TJFCBreakApart = class(TComponent)
  private
...
procedure Register;
begin
  RegisterComponents('Devonic', [TJFCBreakApart]);
end;
...
constructor TJFCBreakApart.Create(AOwner: TComponent);
begin
...
destructor TJFCBreakApart.Destroy;
begin
  FStringList.Free;
  inherited Destroy;
end;
...
procedure TJFCBreakApart.SetStringList(AStringList: TStringList);
begin
...
procedure TJFCBreakApart.BreakApart;
var
...
procedure TJFCBreakApart.ReverseBreakApart;
var
  i: integer;
begin
